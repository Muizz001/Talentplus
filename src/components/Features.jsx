        ...
        <div className='w-full isolate'>
            <div className='w-full flex flex-col lg:flex-row xl:px-[9%] lg:px-[40px] px-[20px] items-center xl:items-start xl:justify-center relative isolate'>
                <div className='xl:w-[50%] w-full xl:max-w-[694px] mt-[40px] flex flex-col xl:items-start items-center xl:mt-[149px]'>
                    <div className='max-w-[381.5px] w-full xl:text-left text-center xl:h-[max-content] xl:max-w-[694px] relative'>
                    ...
                    <div className='max-w-[332px] w-full xl:max-w-[604px] xl:w-[90%] xl:h-[max-content] xl:text-left text-center mt-[8px] xl:mt-[16px]'>
                ...
                <div className='xl:min-w-[50%] w-full max-w-[352px] h-[272px] xl:max-w-[694px] lg:mt-[96px] mt-[40px] xl:h-auto relative mr-[35px] isolate'>
                ...
                <img src={donut} alt="" className='absolute top-[55.11%] right-[0] w-[25px] z-[-10] xl:w-[100px] xl:right-[0] xl:top-[74.6%]' />
